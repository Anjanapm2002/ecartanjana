       ...
       <div className="grid grid-cols-3 gap-4 mt-5">
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="flex">
                        ...
                        <input style={{width:'40px'}} type="text" value={product?.quantity} className="border rounded p-1 mx-2" readOnly />
         ...
         <div className="col-span-1">
           <div className="border rounded shadow p-5">
             ...
             <hr />
             <button onClick={checkout} className="bg-green-600 rounded p-2 text-xl text-white mt-4 w-full">CHECK OUT</button>
           </div>
         </div>
       </div>
       </>
