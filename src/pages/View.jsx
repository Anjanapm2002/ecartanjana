        ...
        <div className="grid grid-cols-2 items-center h-screen">
          <div className='p-5'>
            ...
            <div className='flex justify-between mt-5'>
              <button onClick={handleWishlist} className='bg-blue-600 rounded p-2 text-white'>ADD TO WISHLIST</button>
              <button className='bg-green-600 rounded p-2 text-white '>ADD TO CART</button>
            </div>
          </div>
          <div>
